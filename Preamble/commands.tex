...
\newcommand{\I}{\mc{I}}
\newcommand{\Q}{\mc{Q}} 
\newcommand{\TTS}{\T=(\Q,q_0,\Sigma,\mb{K},\to)}
\newcommand{\TTSg}{\T_g=(\Q_g,q_{0_g},\gamma,\realpos,\to_{\gamma})}
\newcommand{\TTSb}[1]{T_{#1}=(Q_{#1},q_{0_{#1}},\Sigma,
\mb{K},\to_{#1})}
\newcommand{\TTSs}{\T=(\Q,q_0,\A,\realpos,\to)}

\newcommand{\TTSbw}[1]{\T_{#1}=(\Q_{#1},q_{0_{#1}},\Sigma
\cup\{\tau\},\mb{K},\to_{#1})}
