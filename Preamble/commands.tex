...
\newcommand{\TTSbb}[1]{\tts_{#1}=(Q_{#1},q_{0_{#1}},\Sigma\cup\mb{K},\to_{#1})}
\newcommand{\TTSb}[1]{\tts_{#1}=(Q_{#1},q_{0_{#1}},\Sigma\cup\mb{K},\to_{#1})}
\newcommand{\TTSc}[1]{\tts_{#1}=(Q_{#1},q_{0_{#1}},\Sigma\cup\realpoz,\to_{#1})}
...
\newcommand{\forwardp}[2]{\forward^{#2}_{\hspace{-2mm}#1}}
\newcommand{\enabledforward}[1]{Enabled\hspace{-0.8pt}\forward\hspace{-1mm}(#1)}
\newcommand{\enabledforwardb}[3]{Enabled\hspace{-0.8pt}\forwardp{#2}{#3}\hspace{-1mm}(#1)}
...
\newcommand{\reacha}[1]{\stacktxt{Reach(#1)}}
\newcommand{\dte}{dt^{\epsilon}}
...
\newcommand*\circlled[1]{\tikz[baseline=(char.base)]{
